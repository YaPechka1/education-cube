...
<body>
    ...
    <main>
        <div class="container">
            <div class="t1">
                <form name="form" onsubmit="createLecture(event)" class="box t2" >
                ...
                <button class="btn" onclick="redirectTest()">Тесты</button>
                <button class="btn" onclick="redirectPeople()">Участники курса</button>
            </div>
    ...
    include './footer.php'
    ?>
    <script src="/js/lection_list_admin.js"></script>
</body>
