...
<body>
    ...
    <main>
        <div class="container">
            <div class="t1">
                <form name="form" onsubmit="editTest(event)" class="box t2">
                    <label for="">Название теста:</label> <input type="text" name="name">
                    <textarea class="text" name="description" placeholder="Описание теста:"></textarea>
                    <button class="btn">Изменить</button>
                    <span class="total"></span>
                </form>
                <div class="box t2 mark">
                    <h4>Оценка</h4><h4>Количество баллов</h4>
                </div>
            </div>
    ...
    include './footer.php'
    ?>
    <script src="/js/test_editor.js"></script>
</body>
